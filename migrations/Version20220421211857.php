 ...
 */
final class Version20220421211857 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE competence CHANGE title title VARCHAR(255) NOT NULL, CHANGE content content LONGTEXT NOT NULL, CHANGE id_owner id_owner INT UNSIGNED DEFAULT NULL, CHANGE type type VARCHAR(255) NOT NULL');
        ...
        $this->addSql('CREATE INDEX id_domaine_idx ON competence (id_domaine)');
        $this->addSql('CREATE INDEX id_owner_index ON competence (id_owner)');
        ...
        $this->addSql('ALTER TABLE user CHANGE password password VARCHAR(45) NOT NULL, CHANGE image image VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE competence DROP FOREIGN KEY FK_94D4687FA632A3BC');
        $this->addSql('ALTER TABLE competence DROP FOREIGN KEY FK_94D4687F21E5A74C');
        $this->addSql('DROP INDEX id_domaine_idx ON competence');
        $this->addSql('DROP INDEX id_owner_index ON competence');
        $this->addSql('ALTER TABLE competence CHANGE id_owner id_owner INT UNSIGNED NOT NULL, CHANGE title title VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE content content LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE type type VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE user CHANGE password password VARCHAR(4500) NOT NULL, CHANGE image image VARCHAR(255) DEFAULT NULL');
